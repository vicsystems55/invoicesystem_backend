...
{{--
	...
	<!-- Banner Section -->
	<section class="banner-section" style="background-image: url(assets/images/background/2.jpg); background-position: top center; background-size: cover;">
	...
	<!-- Market Section -->
	<section class="market-section d-none">
		<div class="auto-container">
			<div class="row clearfix">
	...
	<!-- App Section Two -->
	<section class="app-section-two d-none" style="background-image: url(assets/images/background/pattern-15.png)">
